...
export function Home() {
  ...
  return (
    <motion.div initial="hidden" animate="visible" className="min-h-screen bg-[#0B0C0E] text-white">
        ...
        <div className="container mx-auto py-4 md:py-6">
          <nav className="flex items-center justify-between">
            <motion.a href="/" className="flex items-center space-x-3 group">
              ...
              <span className="font-mono text-xl">Eunoia</span>
            </motion.a>
            <motion.div
      ...
      {/* Footer */}
      <motion.footer
        className="py-8 mt-16 border-t border-white/5"
        initial={{ opacity: 0 }}
      ...
      >
        <div className="container mx-auto">
          <motion.div className="text-center text-sm text-zinc-400" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <a
              href="#"
              className="inline-flex items-center gap-2 hover:text-white transition-colors relative group"
            >
              <span className="relative overflow-hidden">
                Built By Akshay Esackimuthu
                <motion.span
